...
import PrescricoesCardiologia from "./src/telas/prescricoes/PrescricoesCardiologia";
...
function PrescricoesCardiologia({ onBack }) {
  return (
    <div style={{ minHeight: "100vh", background: COR.bg, fontFamily: "system-ui, sans-serif" }}>
      ...
      <div style={{ padding: "32px 16px", textAlign: "center" }}>
        ...
        <p style={{ color: COR.muted, lineHeight: 1.5 }}>
          ...
          No seu GitHub, basta <b>apagar este bloco</b> e <b>descomentar a importação</b> no topo do ficheiro para que o seu código real seja executado!
        </p>
      </div>
    </div>
  );
